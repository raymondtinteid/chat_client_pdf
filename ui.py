...
# Example list of available models; replace with actual available models if needed
AVAILABLE_MODELS = [
    "gpt-4",
    "gpt-3.5-turbo",
    "gemini-pro",
...
def build_model_dropdown():
    ...
    default_model = llm_client.model if hasattr(llm_client, "model") and llm_client.model in AVAILABLE_MODELS else AVAILABLE_MODELS
    return gr.Dropdown(
